// src/App.jsx — Generated by VIA for: Build me an AI powered resume analyzer that scores resumes and gives improvement tips
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Build Me An Ai Powered Resume Analyzer That</span>
            </Link>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Build Me An Ai Powered Resume Analyzer That</h1>
